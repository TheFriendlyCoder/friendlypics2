...
from qtpy.QtCore import Slot, QTranslator
...
class MyWindow(QMainWindow):
    ...
    def _load_ui(self):
        ...
        self.import_from_pinterest_menu.triggered.connect(self.pinterest_import)
        self.download_pinterest_dump_menu.triggered.connect(self.pinterest_dump)
        self._log.debug(dir(self.open_menu))
        self.open_menu.triggered.connect(self.open)
        #self.file_menu.setShortcut(QTranslator.tr("Ctrl+F"))
    ...
    def _download_file(self, json_response):
        ...
        if extension == ".webp":
            ...
            self._download_pin(url.geturl(), tmp_dir)
            ...
            self._download_pin(url.geturl(), output_folder)
